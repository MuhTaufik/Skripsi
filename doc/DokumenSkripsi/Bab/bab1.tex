...
\item Membuat perangkat lunak yaitu pohon kurikulum dalam bentuk graf.
\end{enumerate}
...
\begin{enumerate}
\item Pilihan Wajib dissatukan dengan Mata Kuliah Pilihan.
\end{enumerate}
...
\item Melakukan studi tentang penggunaan \textit{viz}.js untuk visualisasi pohon kurikulum.
\item Melakukan studi mengenai penggunaan JSON.
...
Bab ini membahas mengenai pengertian graf, data terbuka,\textit{creative commons}, JSON, apa itu DOT \textit{Language}, dan visualisasi graf menggunakan \textit{viz.js.}
\item Bab 3 Analisis \\
Bab ini akan membahas mengenai JSON yang dapat dipakai sebagai sumber data terbuka, analisis perangkat lunak yang akan dibangun, Kebutuhan pada data terbuka, dan spesifikasi perangkat lunak yang dibangun meliputi \textit{use case} dan skenario.
\item Bab 4 Perancangan \\
Bab ini akan membahas mengenai kebutuhan masukan dan keluaran perangkat lunak, perancangan perangkat lunak pohon kurikulum, dan perancangan antarmuka untuk membuat pohon kurikulum. 
\item Bab 5 Implementasi dan Pengujian \\
Bab ini akan membahas mengenai pengujian, implementasi data json yang dipakai, lingkungan implementasi perangkat lunak, dan pengujian perangkat lunak. 
